                ...
                VStack (spacing: 20) {
                    ...
                    GroupBox(label: SettingsLabelView(labelText: "fructus", labelImage: "info.circle")
                        ...
                        HStack (alignment:.center, spacing: 10){
                            ...
                            Text("Most Fruits are naturally low in fat, sodium, and calories. None have cholesterol. Fuits are sources of many essential nutrients, including potassium, diatary fiber, vitamins, and much more.").font(.footnote)
                        }
                        
                        GroupBox(label: SettingsLabelView(labelText: "Customization", labelImage: "paintbrush")){
                            Divider().padding(.vertical, 4)
                            Text("If you would like to see the onboard again.").padding(.vertical,8).frame(minHeight: 60)
                                .layoutPriority(1)
                            ...
                            Toggle(isOn: $isOnboarding){
                                if isOnboarding {
                                    ...
                                    Text("Restart".uppercased()).fontWeight(.bold).foregroundColor(Color.secondary)
                                }
                            }
                            .padding()
                        ...
                        GroupBox(label: SettingsLabelView(labelText: "Application", labelImage: "apps.iphone")){
                            Divider().padding(.vertical, 4)
                            SettingsRowView(name: "Developer", content: "Julieth")
                            SettingsRowView(name: "Designer", content: "Someone")
